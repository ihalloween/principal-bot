...
module.exports = class BotUtils {
  ...
  static async checkForUpdates() {
    const response = await getJson("https://api.github.com/repos/ihalloween/principal-bot/releases/latest");
    ...
    if (response.data) {
      if (
        ...
        warn("download: https://github.com/ihalloween/principal-bot/releases/latest");
      }
    }
  }
